...
int DoMondriaan(struct sparsematrix *A, long int *u, long int *v, struct MondriaanStats *s, int NumProcessors, double Imbalance, int Permutation, int Symmetric, int SplitStrategy) {
	clock_t Clock;
	struct opts Options;
	int i;
	long l;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	int NumProcessors, Permutation, Symm, SplitStrategy;
	double Imbalance;
	long i;
